...
from com_in_detectfaces_mtcnn.Configurations import ConfigurationsPOJO
import warnings
import sys
import dlib
            ...
            if frames % 3 == 0:
                ...
                if len(bboxes) != 0:
                    ...
                    for bboxe in bboxes:
                        ...
                        cv2.putText(
                            frame, text, (bbox[0], y), cv2.FONT_HERSHEY_SIMPLEX, 0.95, (255, 255, 255), 1)
                        cv2.rectangle(
                            frame, (bbox[0], bbox[1]), (bbox[2], bbox[3]), (179, 0, 149), 4)
            else:
                for tracker, text in zip(trackers, texts):
                    ...
                    cv2.rectangle(frame, (startX, startY),
                                  (endX, endY), (179, 0, 149), 4)
                    cv2.putText(frame, text, (startX, startY - 15),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.95, (255, 255, 255), 1)
